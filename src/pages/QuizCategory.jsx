...
const quiz_data = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "Energy and mass equivalence",
        difficulty_level: "Hard",
      },
      {
      ...
      {
        question:
          "What is the process of energy transfer in a solid by vibrations of particles called?",
      ...
      {
        question: "What is the force that causes objects to fall to the Earth?",
        options: [
          "Gravitational force",
          "Magnetic force",
          "Centrifugal force",
      ...
      },
      {
        ...
        options: ["Transverse", "Longitudinal", "Both", "None"],
        answer: "Transverse",
        difficulty_level: "Medium",
      },
      {
      ...
      },
      {
        ...
        options: [
          ...
          "Energy can change shape",
        ],
        answer: "Energy cannot be created or destroyed",
        difficulty_level: "Medium",
      },
      {
        question: "Which type of radiation is used in medical imaging?",
        options: ["X-rays", "Alpha", "Gamma", "Beta"],
        answer: "X-rays",
        difficulty_level: "Medium",
      },
      {
      ...
      },
      {
        ...
        options: [
          "Conductor allows electricity, insulator does not",
          "Insulator allows electricity, conductor does not",
          "Both conduct electricity",
          "None of the above",
        ],
        answer: "Conductor allows electricity, insulator does not",
        difficulty_level: "Medium",
      },
      {
        question: "What is the primary use of a capacitor?",
        options: [
      ...
      {
        question: "What phenomenon causes the rainbow effect?",
      ...
      },
      {
        ...
        answer: "Absorb UV radiation",
        difficulty_level: "Medium",
      },
      {
        question: "What does a simple circuit consist of?",
        options: [
          "Battery, wire, and resistor",
          "Battery, wire, and light bulb",
          "Wire and bulb",
          "Wire and battery only",
        ],
        answer: "Battery, wire, and light bulb",
        difficulty_level: "Easy",
      },
      {
        question: "What does the symbol 'Ω' stand for?",
        options: ["Ohm", "Omega", "Oxygen", "Oxygen Molecule"],
        answer: "Ohm",
        difficulty_level: "Easy",
      },
      {
      ...
      {
        question:
          "What happens to the wavelength of light when it moves from one medium to another?",
        options: ["It changes", "It stays the same", "It doubles", "It stops"],
        answer: "It changes",
        difficulty_level: "Medium",
      },
      {
        ...
        options: [
          ...
          "Time taken for light to travel a year",
          "A unit of time",
          "A unit of speed",
        ],
      ...
      },
      {
        ...
        options: ["F = ma", "F = mv", "F = m/a", "F = ma^2"],
        answer: "F = ma",
        difficulty_level: "Easy",
      },
      {
      ...
      {
        question: "Who invented the first light bulb?",
        options: [
          "Nikola Tesla",
          "Thomas Edison",
      ...
      {
        question: "What is the temperature at which water freezes?",
        options: ["0°C", "-1°C", "32°F", "100°C"],
        answer: "0°C",
        difficulty_level: "Easy",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "The cat is as fast as lightning.",
        difficulty_level: "Medium",
      },
      {
      ...
      },
      {
        ...
        options: ["Sad", "Excited", "Angry", "Joyful"],
        answer: "Sad",
        difficulty_level: "Easy",
      },
      {
        question: "Which of these words is a noun?",
        options: ["Quickly", "Jump", "Happiness", "Run"],
        answer: "Happiness",
        difficulty_level: "Medium",
      },
      {
      ...
      },
      {
        ...
        options: [
          ...
          "She is running like a deer.",
          "The wind whispered.",
        ],
        answer: "Her heart is a cold stone.",
        difficulty_level: "Medium",
      },
      {
        question: "What is the opposite of 'dark'?",
        options: ["Bright", "Light", "Clear", "White"],
        answer: "Light",
        difficulty_level: "Easy",
      },
      {
      ...
      },
      {
        ...
        options: ["Jump", "Quickly", "Big", "Red"],
        answer: "Quickly",
        difficulty_level: "Medium",
      },
      {
        question: "What is the past tense of 'see'?",
        options: ["Saw", "Seen", "See", "Sawen"],
        answer: "Saw",
        difficulty_level: "Easy",
      },
      {
        question: "What does the word 'benevolent' mean?",
        options: ["Kind", "Cruel", "Angry", "Generous"],
        answer: "Kind",
        difficulty_level: "Medium",
      },
      {
        ...
        options: [
          ...
          "While he was going to the store.",
          "She likes pizza.",
          "We went to the movies.",
        ],
        answer: "While he was going to the store.",
        difficulty_level: "Medium",
      },
      {
        question: "What is the future tense of 'write'?",
        options: ["Wrote", "Written", "Writing", "Will write"],
        answer: "Will write",
        difficulty_level: "Easy",
      },
      {
        question: "Which of these is a preposition?",
        options: ["Over", "Run", "He", "Quickly"],
        answer: "Over",
        difficulty_level: "Easy",
      },
      {
        question: "What is the meaning of 'procrastinate'?",
        options: ["To delay", "To finish quickly", "To begin", "To enjoy"],
        answer: "To delay",
        difficulty_level: "Medium",
      },
      {
        ...
        options: [
          ...
          "She is go to the market.",
          "She are go to the market.",
        ],
        answer: "She is going to the market.",
        difficulty_level: "Medium",
      },
      {
      ...
      },
      {
        ...
        options: ["Poor", "Wealthy", "Happy", "Greedy"],
        answer: "Poor",
        difficulty_level: "Easy",
      },
      {
        question: "Which of these words is an adjective?",
        options: ["Quickly", "Jump", "Fast", "Go"],
        answer: "Fast",
        difficulty_level: "Medium",
      },
      {
        question: "What is the plural of 'man'?",
        options: ["Men", "Mans", "Manes", "Menn"],
        answer: "Men",
        difficulty_level: "Easy",
      },
      {
        ...
        answer: "A noun that receives the action",
        difficulty_level: "Medium",
      },
      {
        question: "Which of these words is a conjunction?",
        options: ["But", "She", "Blue", "Slow"],
        answer: "But",
        difficulty_level: "Easy",
      },
    ],
  },
  {
    category: "Biology",
    Image:
      "https://t4.ftcdn.net/jpg/02/35/71/13/360_F_235711378_x8BsTR14c7Iu9myWbXVBk2DHf7dHsdgg.jpg",
    questions: [
      {
      ...
      {
        question:
          "What is the term for a species' complete role in an ecosystem?",
        options: ["Habitat", "Community", "Niche", "Biome"],
        answer: "Niche",
        difficulty_level: "Medium",
      },
      {
      ...
      },
      {
        ...
        options: ["Meiosis", "Mitosis", "Binary fission", "Transcription"],
        answer: "Mitosis",
        difficulty_level: "Medium",
      },
      {
        question:
          "What is the term for the genetic material that is passed from parent to offspring?",
        options: ["RNA", "DNA", "Protein", "Chlorophyll"],
        answer: "DNA",
        difficulty_level: "Easy",
      },
      {
      ...
      {
        question: "Which organism is the largest living organism?",
        options: [
          "Blue whale",
          "Giant sequoia",
          "Honey fungus",
      ...
      {
        question:
          "Which part of the brain is responsible for regulating heartbeat?",
      ...
      {
        question:
          "What process allows plants to take in carbon dioxide from the air?",
        options: [
          "Photosynthesis",
          "Respiration",
          "Transpiration",
      ...
      },
      {
        ...
        options: ["Heart", "Pancreas", "Liver", "Kidney"],
        answer: "Pancreas",
        difficulty_level: "Medium",
      },
      {
        question: "What is the first stage of human embryonic development?",
        options: ["Zygote", "Fetus", "Blastocyst", "Embryo"],
        answer: "Zygote",
        difficulty_level: "Medium",
      },
      {
        question: "Which of these is NOT a part of the central nervous system?",
        options: ["Spinal cord", "Brain", "Nerves", "Medulla"],
        answer: "Nerves",
        difficulty_level: "Medium",
      },
      {
      ...
      {
        question:
          "What is the term for the conversion of glucose to energy in cells?",
        options: ["Fermentation", "Respiration", "Photosynthesis", "Digestion"],
        answer: "Respiration",
        difficulty_level: "Easy",
      },
      {
      ...
      },
      {
        ...
        options: ["Homeostasis", "Metabolism", "Mitosis", "Photosynthesis"],
        answer: "Homeostasis",
        difficulty_level: "Medium",
      },
      {
      ...
      },
      {
        ...
        options: ["Transpiration", "Absorption", "Condensation", "Evaporation"],
        answer: "Transpiration",
        difficulty_level: "Medium",
      },
      {
        question: "What is the largest artery in the human body?",
        options: ["Aorta", "Carotid", "Pulmonary", "Femoral"],
        answer: "Aorta",
        difficulty_level: "Easy",
      },
      {
        question: "Which type of muscle is responsible for voluntary movement?",
        options: [
          "Smooth muscle",
          "Cardiac muscle",
          "Skeletal muscle",
      ...
      {
        question: "Which vitamin is primarily found in citrus fruits?",
      ...
      {
        question: "Which process creates new cells in organisms?",
        options: ["Mitosis", "Meiosis", "Cell division", "All of the above"],
        answer: "Mitosis",
        difficulty_level: "Medium",
      },
      {
        question: "Which hormone regulates sleep in humans?",
        options: ["Insulin", "Cortisol", "Melatonin", "Adrenaline"],
        answer: "Melatonin",
        difficulty_level: "Medium",
      },
    ],
  },
  {
    category: "Chemistry",
    Image:
      "https://plus.unsplash.com/premium_photo-1681426678542-613c306013e1?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Y2hlbWlzdHJ5fGVufDB8fDB8fHww",
    ...
    questions: [
      ...
      {
        question:
          "What is the process of separating a solid from a liquid by evaporation?",
        options: [
          "Filtration",
          "Distillation",
          "Condensation",
      ...
      },
      {
        ...
        options: ["Atomic mass", "Atomic number", "Density", "Boiling point"],
      ...
      {
        question:
          "What is the process of a substance changing from a solid to a liquid?",
        options: ["Sublimation", "Melting", "Freezing", "Boiling"],
        answer: "Melting",
        difficulty_level: "Easy",
      },
      {
        question: "What is the name for a positively charged ion?",
        options: ["Cation", "Anion", "Proton", "Electron"],
        answer: "Cation",
        difficulty_level: "Medium",
      },
      {
        question: "Which of the following is an example of an acid?",
        options: ["Acetic acid", "Sodium hydroxide", "Ammonia", "Water"],
        answer: "Acetic acid",
        difficulty_level: "Medium",
      },
      {
        question: "Which element is commonly used in batteries?",
        options: ["Lithium", "Oxygen", "Iron", "Carbon"],
        answer: "Lithium",
        difficulty_level: "Medium",
      },
      {
      ...
      },
      {
        ...
        options: ["Oxygen", "Carbon", "Gold", "Nitrogen"],
        answer: "Gold",
        difficulty_level: "Easy",
      },
      {
        question: "What is the term for the amount of matter in an object?",
        options: ["Weight", "Density", "Mass", "Volume"],
        answer: "Mass",
        difficulty_level: "Easy",
      },
      {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          "Conflict between Germany and Russia",
          "Conflict between USA and China",
        ],
        answer: "Conflict between USA and USSR",
        difficulty_level: "Medium",
      },
      {
      ...
      },
      {
        ...
        options: ["Sumerians", "Egyptians", "Indus Valley", "Maya"],
        answer: "Sumerians",
        difficulty_level: "Medium",
      },
      {
        question: "Who was the last queen of Egypt?",
        options: ["Cleopatra", "Nefertiti", "Hatshepsut", "Elizabeth I"],
        answer: "Cleopatra",
        difficulty_level: "Medium",
      },
      {
      ...
      },
      {
        ...
        options: ["Qin Shi Huang", "Han Wu Di", "Kublai Khan", "Emperor Yang"],
        answer: "Qin Shi Huang",
        difficulty_level: "Medium",
      },
      {
        question: "What year did the French Revolution begin?",
        options: ["1789", "1799", "1800", "1776"],
        answer: "1789",
        difficulty_level: "Medium",
      },
      {
      ...
      {
        question:
          "Which empire ruled most of Europe and the Middle East for centuries?",
        options: [
          "Roman Empire",
          "Ottoman Empire",
          "Byzantine Empire",
      ...
      {
        question: "Which battle was fought on June 6, 1944?",
        options: [
          "Battle of the Bulge",
          "Battle of Normandy",
      ...
      },
      {
        ...
        options: ["Apollo 11", "Apollo 13", "Gemini 4", "Luna 2"],
        answer: "Apollo 11",
        difficulty_level: "Medium",
      },
      {
        question:
          "Which empire conquered most of the known world in the 4th century BC?",
        options: [
          "Roman Empire",
          "Mongol Empire",
          "Persian Empire",
        ...
        answer: "Alexander's Empire",
        difficulty_level: "Medium",
      },
      {
        question:
          "Which country was the first to grant independence to its colonies?",
        options: ["United Kingdom", "United States", "France", "Spain"],
        answer: "United Kingdom",
        difficulty_level: "Medium",
      },
      {
        question: "What was the name of the first artificial satellite?",
        options: ["Sputnik", "Explorer", "Apollo", "Vanguard"],
        answer: "Sputnik",
        difficulty_level: "Medium",
      },
      {
  ...
  },
  {
    category: "Computer",
    Image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaZfOPpD8TES9LYS2S_KF057K5ptvLP479cQ&s",
    questions: [
      {
      ...
      },
      {
        ...
        options: ["Google", "Windows", "Apple", "Linux"],
        answer: "Google",
        difficulty_level: "Easy",
      },
      {
      ...
      },
      {
        ...
        options: ["Malware", "Spyware", "Virus", "Adware"],
        answer: "Malware",
        difficulty_level: "Medium",
      },
      {
        question: "Which technology is used for wireless communication?",
        options: ["Bluetooth", "USB", "Ethernet", "HDMI"],
        answer: "Bluetooth",
        difficulty_level: "Medium",
      },
      {
      ...
      },
      {
        ...
        answer: "Monitor incoming traffic",
        difficulty_level: "Medium",
      },
      {
      ...
      },
      {
        ...
        options: ["Trojan", "Firewall", "Router", "Switch"],
        answer: "Trojan",
        difficulty_level: "Medium",
      },
      {
      ...
      {
        question: "What type of software is Windows?",
        options: [
          "Operating System",
          "Antivirus",
          "Utility Software",
...
function QuizCategory() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://images.pexels.com/photos/2680270/pexels-photo-2680270.jpeg')",
      }}
    >
      <div className="mb-4">
